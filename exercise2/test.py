...
from cnn_tf import Cnn_Tensorflow 
...
def mnist(datasets_dir='./data'):
    ...
    return train_x, train_y, valid_x, valid_y, test_x, one_hot(test_y)
...
def main(unused_argv):
  ...
  train_data, train_labels, eval_data, eval_labels, x_test, y_test = mnist(args.input_path)
  ...
  mnist_classifier = tf.estimator.Estimator(
      model_fn=Cnn_Tensorflow.cnn_tensorflow, model_dir="./models")
